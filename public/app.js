...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const cargarProductos = async () => {
    try {
      ...
      productosCont.innerHTML = `<p style="color:red;">${err.message}</p>`;
    }
  };
  ...
  function actualizarUI(estaLogueado, username = "", role = "cliente") {
    if (estaLogueado) {
      ...
      authSection.querySelector('#register').style.display = 'none';
      authSection.querySelector('#login').style.display = 'none';
      authSection.querySelectorAll('hr').forEach(hr => hr.style.display = 'none');
      ...
      // Mostrar productos y carrito (para todos los logueados)
      ...
      // --- Ocultar todo si no está logueado ---
